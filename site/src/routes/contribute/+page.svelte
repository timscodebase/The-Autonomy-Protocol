<script lang="ts">
    import HeroImage from '$images/img-4.jpg?enhanced&w=400;800;1600;2400';
</script>
...
<section class="hero">
	...
	<div>
		...
		<p>
      Would you like to contribute to this project?  We need teachers and administrators with experience to help build lesson plans, homework, artwork and other content.  You could help shap the future of our students and future leaders!
		</p>
	</div>
</section>
...
Objective: What specific behavioral shift is being addressed?
Pedagogical Logic: Why does this specific exercise result in that shift?
The Practicum: A concrete, applied learning exercise for students.
Assessment: How will an educator measure success?
Step 3: Peer Review
